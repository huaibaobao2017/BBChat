...
extension UIViewController {
    ...
    // alert
    func alert(title: String? = nil, message: String? = nil, comfirm: String? = "确定") {
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let ok = UIAlertAction(title: comfirm, style: .default, handler: nil)
        alert.addAction(ok)
        self.present(alert, animated: true, completion: nil)
    }
    
    // comfirm
    func comfirm(title: String? = nil, message: String? = nil, comfirm: String? = "确定", onDismissBlock: @escaping ()->()) {
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let ok = UIAlertAction(title: comfirm, style: .default) { (action) in
            onDismissBlock()
        }
    ...
    // actionsheet
    func actionsheet(title: String? = nil, message: String? = nil, buttons: [String], onDismissBlock: @escaping (Int)->()) {
        let alertController = UIAlertController(title: title, message: message, preferredStyle: .actionSheet)
        for (index, value) in buttons.enumerated() {
            let action = UIAlertAction(title: value, style: .default) { (action) in
                onDismissBlock(index)
            }
